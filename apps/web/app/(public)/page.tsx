...
const CATEGORY_IMAGES: Array<[string, string]> = [
  ...
  ['calzado', '/categories/footwear_v2.svg'],
  ...
  ['mascota', '/categories/pets_v2.svg'],
  ['servicio', '/categories/services_v2.svg'],
  ['salud', '/categories/health_v2.svg'],
  ['juguete', '/categories/toys_v2.svg'],
  ['bebe', '/categories/babies_v2.svg'],
  ['bebé', '/categories/babies_v2.svg'],
