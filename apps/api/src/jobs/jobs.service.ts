...
export class JobsService {
  constructor(
    @Inject(SEARCH_QUEUE_TOKEN)
    private readonly searchQueue: Queue<SearchIndexJobData>,
    @Inject(NOTIFICATION_QUEUE_TOKEN)
    private readonly notificationQueue: Queue<NotificationJobData>,
    @Inject(ML_IMPORT_QUEUE_TOKEN)
    private readonly mlImportQueue: Queue<MlImportJobData>,
  ) {}
