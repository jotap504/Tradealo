...
export const CATEGORY_ATTRIBUTES_SEED: CategoryAttributeSeed[] = [
  ...
  },
  {
    ...
    label: 'Frenos',
    type: 'select',
    options: ['Disco mecánico', 'Disco hidráulico', 'Pinza (rim brake)'],
    sortOrder: 5,
  },
  {
    categorySlug: 'bicicletas-ruta',
  ...
  },
  {
    ...
    label: 'Material del cuadro',
    type: 'select',
    options: ['Aluminio', 'Acero', 'Acero cromoly'],
    sortOrder: 4,
  },
  {
    categorySlug: 'bicicletas-fixie',
    ...
    label: 'Color',
    type: 'select',
    options: ['Negro', 'Blanco', 'Gris', 'Azul', 'Rojo', 'Verde', 'Otro'],
    isVariant: true,
    sortOrder: 5,
  },
  {
  ...
  },
  {
    ...
    label: 'Modalidad',
    type: 'select',
    options: ['Street', 'Park', 'Dirt/Jump', 'Race', 'Freestyle'],
    sortOrder: 3,
  },
  {
    categorySlug: 'bicicletas-bmx',
    ...
    label: 'Material del cuadro',
    type: 'select',
    options: ['Acero hi-ten', 'Acero cromoly', 'Aluminio'],
    sortOrder: 4,
  },
  {
    categorySlug: 'bicicletas-bmx',
  ...
  },
  {
    categorySlug: 'perros',
    key: 'peso_envase_kg',
    label: 'Peso del envase (kg)',
    type: 'select',
    options: ['1', '2', '3', '4', '7.5', '15', '20'],
    isVariant: true,
    sortOrder: 5,
  },
  ...
  // ── JUGUETES 3-8 AÑOS ────────────────────────────────────────────────────
  {
    ...
    options: [
      'Muñecas/Muñecos',
      'Autos/Vehículos a escala',
      'Juego de roles',
      'Bloques básicos',
      'Rompecabezas',
      'Arte/Manualidades',
      'Juego de mesa simple',
  ...
  },
  {
    ...
    type: 'select',
    options: ['3 años', '4 años', '5 años', '6 años', '7 años', '8 años'],
    sortOrder: 2,
  },
  {
    categorySlug: 'juguetes-3-8',
  ...
  // ── SERVICIOS EDUCACIÓN ─────────────────────────────────────────────────
  {
    ...
    key: 'tipo_curso',
    label: 'Tipo de curso/servicio',
    type: 'select',
    options: [
      'Clases particulares',
      'Tutoría/Refuerzo escolar',
      'Idiomas',
      'Música',
      'Arte/Dibujo',
      'Programación',
  ...
  },
  {
    ...
    label: 'Motor',
    type: 'select',
    options: ['Sin motor', 'Eléctrico', 'Nafta 2T', 'Nafta 4T', 'Diésel'],
    sortOrder: 4,
  },
  {
    categorySlug: 'nautica',
  ...
  },
  {
    ...
    label: 'Talle (si aplica)',
    type: 'select',
    options: ['XS', 'S', 'M', 'L', 'XL', 'XXL', 'Unitalla'],
    isVariant: true,
    sortOrder: 3,
  },
  {
